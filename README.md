...
## Init
```bash
git clone https://github.com//hexo-theme-beantech.git ./hexo-beantech
cd hexo-beantech
npm install
```
...
Please [Star](https://github.com//hexo-theme-beantech) this Project if you like it! [Follow](https://github.com/) would also be appreciated!
Peace!
